...
(function () {
  ...
  if (Support) {
    ...
    window.addEventListener('load', toggleSupport)
    onscroll(document, toggleSupport)
  }
  // Social Icons
  let Social = select('.social')
  if (Social) {
    const toggleSocial = () => {
      if (window.scrollY > 100) {
    ...
    onscroll(document, toggleSocial)
  }
...
if (isMobileDevice) {
  ...
  document.getElementById("mainLogo").style.margin = "auto";
   document.getElementById("slide").style.height = "250px"; 
   document.getElementById("slides").style.marginTop = "0"; 



   document.getElementById("Support-form").style.width = "73%";
   document.getElementById("Support-form").style.bottom = "8%";
